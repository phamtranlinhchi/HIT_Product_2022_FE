        ...
        <div className="topreader">
            ...
            <div className="topreader_trophies">
                <div className="topreader_trophies-trophy">
                    ...
                    <div className="topreader_trophies-trophy-name home-box">accounttest</div>
                </div>
                <div className="topreader_trophies-trophy">
            ...
            <div className="topreader_myrank">
                ...
                <div className="topreader_myrank-mine">
                    <div className="topreader_myrank-mine-rank">7</div>
                    <div className="topreader_myrank-mine-name home-box">accounttest</div>
                </div>
            </div>
        </div>
    );
